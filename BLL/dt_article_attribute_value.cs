...
namespace BLL
{
	...
	{
		private readonly DAL.dt_article_attribute_value dal=new DAL.dt_article_attribute_value();
        ...
        ///// 得到一个对象实体，从缓存中
        ///// </summary>
        //public Model.dt_article_attribute_value GetModelByCache(int article_id)
        //{
			
        //    string CacheKey = "dt_article_attribute_valueModel-" + article_id;
        ...
        //        catch{}
        //    }
        //    return (Model.dt_article_attribute_value)objModel;
        //}
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.dt_article_attribute_value> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.dt_article_attribute_value> DataTableToList(DataTable dt)
		{
			List<Model.dt_article_attribute_value> modelList = new List<Model.dt_article_attribute_value>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Model.dt_article_attribute_value model;
